...
//  yy453_p4
//
//  Created by 无比机智的树懒大人 on 10/28/18.
...
//}
class Songtableview: UITableViewCell{
    ...
    func configure(for song: Songs) {
        nameLabel.text = song.name
        artLabel.text = "Artist: \(song.artist)"
        albLabel.text = "Albumn: \(song.albumn)"
